...
家煜，就讀於國立臺中科技大學五專部資訊工程科。回顧進入這個領域的起點，是一個清晰的志向，不如說是一種對「想解決問題」的天生執念。從小我就對「思考問題的解法」格外感興趣，時常在思考：這樣處理能否解決問題？是否有更快、更有效的方法？換一個零件能不能讓它重新運作？這種面對問題時想搞清楚根源、而非繞路迴避的習慣，在我接觸程式設計後找到了最適合它生長的土壤。專一修習網頁設計與程式設計時，讓我意識到：程式是一種工具，可以幫助我解決日常生活真實的問題。下課後我並未停下，在課外自學各種技術——不是為了成績，而是想知道「我到底可以做到什麼程度」。
...
洞察客戶需求 解決問題 創造價值
經過以上實務經驗，發覺我所寫出來的產品需要更符合客戶所需要的，才能創造價值，因此才期望能透過雲科資管的訓練 培養我關於 目標1 目標2 目標3的能力 todo 

--三件事讓我確認：資工培養我「做得出東西」，實務世界更需要「做對的東西」。-- 我申請雲科資管二技，
...
我的學習計畫以「增強管理面的系統訓練、延續技術面的整合深度」為核心，對應雲科資管系所之「資訊科技與管理並重」與「資訊系統開發與管理」兩大特色，分為短、中、長期三階段規劃如下。

### ▸ 既有能力 × 實務缺口 × 雲科資管對應課程／方向（對照表）

| 既有能力（資工訓練） | 期待培養的技能 | 雲科資管對應課程／發展方向 |
|---|---|---|
...
兩段英文研討會論文發表經驗（TWELF 2025 中英文摘要、FC 2025 全英文論文與口頭報告）讓我意識到——軟體業已是日常面對英文文件、英文同步協作的環境，我希望在二技期間進一步強化英文實戰能力：
...
- 外商挑戰：持續精進技術深度與英文能力，期許進入 Google ／ Amazon 等外商研發環境。把雲科資管所學的「技術 × 管理 × 組織」整合視角，帶到跨國、跨文化的工程組織中

### 4-3　長期｜ 從技術交付者邁向 AI × 管理整合人才

- 投入高技術密度研發環境，參與「系統設計 → AI 整合」的完整開發流程；典型方向如製造業 AI 視覺檢測、製程自動化，對應「資訊技術的策略應用」與「製造執行系統」課程脈絡。
- 持續進修攻讀雲科資管碩士班，深入資料探勘 ／ AI 應用管理方向，並以二技與業界實務經驗作為研究問題的來源。
- 長期目標：成為具備 「技術可行性 × 商業合理性 × 組織適配性」的國際團隊協作整合型人才。
